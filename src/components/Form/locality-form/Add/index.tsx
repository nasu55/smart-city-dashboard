...
const mySchema = z.object({
  localityName: z.string().trim().min(1, { message: "Category Id is required." }),
...
const LocalityAddForm = () => {
  ...
  const submitData = async (data: any) => {
    try {
      ...
      const response = await localityApi.createLocality(data);
...
export default LocalityAddForm;
